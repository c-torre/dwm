...
static const char *fonts[]          = { "sans:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
const char *spcmd2[] = {"st", "-n", "spcalc", "-f", "sans:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
